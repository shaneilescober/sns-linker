<div id = "add_setup_container">
	<form id = "save" name = "save">
		...
		<table class = "table_input_vr" cellspacing = "0" border = "1">
			...
			<tbody>
				<tr>
					...
					<td>
						<span class = "neccesary">*</span>
						<input id = "titulo" class = "fix" type = "text" validate = "required" maxlength = "20" name = "title" value = "" fw-filter = "isFill" >
					</td>
				</tr>
				<tr>
					<th>Link Address</th>
					<td>
						<span class = "neccesary">*</span>
						<input id="linkadd" class="input_keyword fix" type="text" name="link" title="" validate="required|url" value="" maxlength="255" fw-filter="isFill&isUrl">
					</td>
				</tr>
				<tr>
					<th>Link Image</th>
				...
				<tr>
					<th></th>
					<td>
						<div id = "selectedImg_container"><img src = "/_sdk/img/snslinkwidget/google_logo.jpg"></div>
						...
						<input type = hidden name = "sel_image" id = "sel_image" value = "/_sdk/img/snslinkwidget/google_logo.jpg">
					</td>
				</tr>
			</tbody>
		</table>
		...
		<div class = "tbl_lb_wide_btn">
			<input id="save-setup" class="btn_apply" type="button" value="Save">
